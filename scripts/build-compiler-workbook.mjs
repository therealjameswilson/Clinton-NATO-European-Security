...
async function main() {
  ...
  addDataSheet(workbook, "Promotion Queue", "Scout/Catalog extraction and released-source triage worksheet.", promotionQueue, [
    ...
    { key: "hard_gap_triage_order", header: "Hard-Gap Triage", type: "number", width: 125 },
    { key: "hard_gap_promotion_lane", header: "Hard-Gap Lane", width: 190 },
    { key: "hard_gap_direct_credit", header: "Hard-Gap Credit", width: 260 },
    { key: "hard_gap_decision", header: "Hard-Gap Decision", width: 170 },
    { key: "hard_gap_blocking_issue", header: "Hard-Gap Blocker", width: 360 },
